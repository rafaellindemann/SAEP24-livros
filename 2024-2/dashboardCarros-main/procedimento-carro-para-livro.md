...
WIP: corrigindo o procedimento para ajeitar os números de linhas e alterações. Parei no 1.3
...
1. Linha 9: Alterar 'alugaCarros' para 'biblioteca'

2. Linhas 19, 30, 45, 59, 97: Substituir '/carros' por '/livros'
